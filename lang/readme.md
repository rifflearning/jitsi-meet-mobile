Riff Connect Translation
==========================
Riff Connect uses [i18next](http://i18next.com) library for translation.
i18next uses separate json files for each language.


Translating Riff Connect
======================
The translation of Riff Connect is handled editing manually the language files.

Development
===========
If you want to add new functionality for Riff Connect and you have texts that need to be translated you must add key and value in main.json file in English for each translatable text.
