...
import { LightBtn, PurpleBtn } from 'Components/styled';
...
const Dropdown = styled.div`
    ...
    background: ${Colors.white};
    border-radius: 4px;
    border: solid 1px ${rgbaColor(Colors.riffViolet, .2)};
    box-shadow: 0 2px 4px -1px ${
    rgbaColor(Colors.black, .2)},
        0 1px 10px 0 rgba(0, 0, 0, 0.12),
        0 4px 5px 0 ${rgbaColor(Colors.black, .14)};
