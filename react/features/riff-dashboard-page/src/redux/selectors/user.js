...
function getUserId(state) {
    return APP.store.getState()["features/riff-platform"].signIn.user.uid;
...
function getUserEmail(state) {
    return APP.store.getState()["features/riff-platform"].signIn.user.email;
...
function getUserName(state) {
    return APP.store.getState()["features/riff-platform"].signIn.user.displayName;
