...
function SignUp({ doRegister, signUpError, signingUp }) {
      ...
      <div className={classes.paper}>
        ...
        <form className={classes.form} noValidate onSubmit={handleSubmit}>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <FormControl required error={Boolean(policyError)} component="fieldset" className={classes.formControl}>
                <FormControlLabel
                  required
                  control={<Checkbox value="agreeTermsAndPolicy" checked={policy} color="primary" onChange={onChangePolicy} />}
